...
model_output_dir = f"/pfs/work9/workspace/scratch/ma_mkleinma-thesis/trained_models_multilabel/ResNet50_BCos_FLC_{args.augmentation}_{samp_text}/seed_{args.seed}"
