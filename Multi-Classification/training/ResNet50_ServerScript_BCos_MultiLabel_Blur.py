...
model_output_dir = f"/pfs/work9/workspace/scratch/ma_mkleinma-thesis/trained_models_multilabel/ResNet50_BCos_Blur_{args.augmentation}_{samp_text}/seed_{args.seed}"
...
for current_fold, (train_idx, val_idx) in enumerate(splits):
    ...
    for epoch in range(num_epochs):
        ...
        if (recall > best_recall):
            best_recall = recall
            torch.save(model.state_dict(), os.path.join(model_output_dir, f"pneumonia_detection_model_resnet_bcos_bestrecall_{fold}.pth"))
