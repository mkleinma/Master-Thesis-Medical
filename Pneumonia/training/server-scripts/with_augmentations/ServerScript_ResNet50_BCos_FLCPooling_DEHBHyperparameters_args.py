...
model_output_dir = f"/pfs/work7/workspace/scratch/ma_mkleinma-thesis/trained_models/30_epochs_bcos_resnet50_dehb_flc_{args.augmentation}_{samp_text}/seed_{args.seed}"
