...
model_output_dir = f"/pfs/work7/workspace/scratch/ma_mkleinma-thesis/trained_models/30_baseline_trans_conv_dehb_{args.augmentation}_{samp_text}/seed_{args.seed}"
