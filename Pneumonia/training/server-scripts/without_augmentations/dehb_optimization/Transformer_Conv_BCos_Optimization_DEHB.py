...
logging.basicConfig(filename="train_debug_dehb_trans_bcos.log", level=logging.DEBUG, format="%(asctime)s - %(levelname)s - %(message)s")
...
de = DEHB(f=train_model,
    ...
    output_path="/pfs/work7/workspace/scratch/ma_mkleinma-thesis/dehb_results/trans_bcos/",
    n_workers=1)
